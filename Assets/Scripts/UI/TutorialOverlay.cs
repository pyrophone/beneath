...
public class TutorialOverlay : AbstractCanvas
{
	...
	private void Start()
	{
		...
		tutorialDialogue.Add("Tap on the scroll at the bottom of the screen to see what tasks lie ahead.");
		tutorialDialogue.Add("As a newcomer to the city, you only have one available task. As you finish tasks and explore the city, more will become available to you.");
